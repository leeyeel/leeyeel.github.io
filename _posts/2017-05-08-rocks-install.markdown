...
各节点的线路连接如图所示,    
![]({{ '/assets/rocks/physical_assembly.png' | relative_url }})    
...
![Sidewinder]({{ '/assets/rocks/Sidewinder.png' | relative_url }})    
...
不要感到疑惑。  
![select01]({{ '/assets/rocks/select01.png' | relative_url }})    
...
![select02]({{ '/assets/rocks/select02.png' | relative_url }})    
...
![select03]({{ '/assets/rocks/select03.png' | relative_url }})    
...
![ipSet01]({{ '/assets/rocks/ipSet01.png' | relative_url }})    
...
![last]({{ '/assets/rocks/last.png' | relative_url }})     
...
```
会看到如下界面:
![insert-ethers-1]({{ '/assets/rocks/insert-ethers-1.png' | relative_url }})     
...
![insert-ethers-5]({{ '/assets/rocks/insert-ethers-5.png' | relative_url }})     
