...
![]({{ '/assets/autosar/graphical-c-s.png' | relative_url }})

##### 发送者-接收者

当组分为发送者-接收者模式时，他们有自己的图形接口表示方法,如下所示:  
![]({{ '/assets/autosar/graphical-s-r.png' | relative_url }})

##### 刻度

当组分为刻度模式时，他们有自己的图形接口表示方法,如下所示:  
![]({{ '/assets/autosar/graphical-c.png' | relative_url }})
...
### 映射到OS任务
看下面这图就懂了.
![]({{ '/assets/autosar/mapping.png' | relative_url }})
