...
![]({{ '/assets/lauterbach/powerdebugpro.jpg' | relative_url }})
另一端根据不同的处理架构使用不同的扩展与MCU相连。实物图如下所示：

![]({{ '/assets/lauterbach/3_powerdebugpro.jpg' | relative_url }})

主页上有对不同处理器构架支持扩展的详细介绍。硬件上的连接方式下图所示：

![]({{ '/assets/lauterbach/1_connection.png' | relative_url }})
...
![]({{ '/assets/lauterbach/4_modifiedMemory.webp' | relative_url }})
...
![]({{ '/assets/lauterbach/9_setBreakPoint.png' | relative_url }})
...
![]({{ '/assets/lauterbach/5_softBreakPoint.webp' | relative_url }})
...
![]({{ '/assets/lauterbach/6_onChipBreakPoint.webp' | relative_url }})

- 更改默认断点类型

对程序代码来说，默认的断点类型为软件中断，如果代码完全位于ROM中，默认中断类型可以通过**Break - Implementation**来改变，如下图:

![]({{ '/assets/lauterbach/7_changeBreakPointType.png' | relative_url }})
...
![]({{ '/assets/lauterbach/8_onChipRange.png' | relative_url }})
...
![]({{ '/assets/lauterbach/10_readBreakPoint.png' | relative_url }})
...
![]({{ '/assets/lauterbach/11_runTime.png' | relative_url }})

- 任务占用率

TRACE32可以统计各个人物的CPU占用率, 原理是对PC采样。具体实现方法可参考 *Debugger Basics - Training*,最终实现的效果见下图:

![]({{ '/assets/lauterbach/12_taskSampling.png' | relative_url }})
