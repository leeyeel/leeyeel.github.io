...
客户端向服务断请求信息内容如下
![]({{ '/assets/UDS/DTC/reportNumberOfDTCByStatusMask_request.png' | relative_url }})

服务端响应客户端内容如下

![]({{ '/assets/UDS/DTC/reportNumberOfDTCByStatusMask_response.png' | relative_url }})
...
![]({{ '/assets/UDS/DTC/DTCFormatIdentifier.png' | relative_url }})
...
客户端向服务断请求信息内容如下
![]({{ '/assets/UDS/DTC/reportDTCByStatusMask_request.png' | relative_url }})

服务端响应客户端内容如下

![]({{ '/assets/UDS/DTC/reportDTCByStatusMask_response.png' | relative_url }})

如果没有任何DTC的实际Status与StatusMask匹配，则服务端将不返回任何DTC，这时客户端向服务端的请求信息与上面一致，服务端响应客户端内容如下:

![]({{ '/assets/UDS/DTC/reportDTCByStatusMask_response2.png' | relative_url }})
...
客户端向服务断请求信息内容如下
![]({{ '/assets/UDS/DTC/reportDTCSnapshotIdentification_request.png' | relative_url }})

服务端响应客户端内容如下

![]({{ '/assets/UDS/DTC/reportDTCSnapshotIdentification_response.png' | relative_url }})
...
![]({{ '/assets/UDS/DTC/DTCSnapshot_record_content.png' | relative_url }})

本例中服务端返回了1个DTCSnapshot记录。
客户端向服务断请求信息内容如下
![]({{ '/assets/UDS/DTC/reportDTCSnapshotRecordByDTCNumber_request.png' | relative_url }})

服务端响应客户端内容如下

![]({{ '/assets/UDS/DTC/reportDTCSnapshotRecordByDTCNumber_response.png' | relative_url }})
...
客户端向服务断请求信息内容如下
![]({{ '/assets/UDS/DTC/reportDTCStoredDataByRecordNumber_request.png' | relative_url }})

服务端响应客户端内容如下

![]({{ '/assets/UDS/DTC/reportDTCStoredDataByRecordNumber_response1.png' | relative_url }})
![]({{ '/assets/UDS/DTC/reportDTCStoredDataByRecordNumber_response2.png' | relative_url }})
...
![]({{ '/assets/UDS/DTC/DTCExtDataRecordNumber.png' | relative_url }})

本例中，客户端请求信息中DTCExtDataRecordNumber的值为0xFF,表示请求所有符合条件的记录，服务端将返回所有可用的(本例子中2个)DTCExtendedData。

客户端向服务断请求信息内容如下
![]({{ '/assets/UDS/DTC/reportDTCExtDataRecordByDTCNumber_request.png' | relative_url }})

服务端响应客户端内容如下
![]({{ '/assets/UDS/DTC/reportDTCExtDataRecordByDTCNumber_response.png' | relative_url }})
...
客户端向服务断请求信息内容如下:
![]({{ '/assets/UDS/DTC/reportNumberOfDTCBySeverityMaskRecord_request.png' | relative_url }})

服务端响应客户端内容如下
![]({{ '/assets/UDS/DTC/reportNumberOfDTCBySeverityMaskRecord_response.png' | relative_url }})
