...
![]({{ '/assets/gif/truecolor2.gif' | relative_url }})![]({{ '/assets/gif/gif_file_stream.gif' | relative_url }})
...
![]({{ '/assets/gif/sample_1.gif' | relative_url }})

注意实线框为必须项，虚线框为可选项。

![]({{ '/assets/gif/binary-raw.png' | relative_url }})

上图是个极其简单的GIF图，它的分辨率只有10x10，最多只支持4种颜色，每种颜色用2位二进制数表示。

![]({{ '/assets/gif/header_block.gif' | relative_url }})
...
![]({{ '/assets/gif/logical_screen_desc_block.gif' | relative_url }})

- Logical Screen Descriptor

![]({{ '/assets/gif/global_color_table.gif' | relative_url }})
...
![]({{ '/assets/gif/graphic_control_ext.gif' | relative_url }})
...
![]({{ '/assets/gif/image_descriptor_block.gif' | relative_url }})
...
![]({{ '/assets/gif/interlaced.gif' | relative_url }})
...
![]({{ '/assets/gif/image_data_block.gif' | relative_url }})![]({{ '/assets/gif/comment_ext.gif' | relative_url }})
...
![]({{ '/assets/gif/trailer_block.gif' | relative_url }})
...
![]({{ '/assets/gif/comment_ext.gif' | relative_url }})
