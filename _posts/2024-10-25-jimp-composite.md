...
![]({{ '/assets/jimp/composite/sample.jpeg' | relative_url }})
![]({{ '/assets/jimp/composite/front.jpeg' | relative_url }})
...
![]({{ '/assets/jimp/composite/srcover.webp' | relative_url }})

- DST_OVER = "dstOver"

将源图像叠加在目标图像之下,所以除非目标图像半透明，否则根本看不到源图像。

![]({{ '/assets/jimp/composite/dstover.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/multiply.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/add.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/screen.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/overlay.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/darken.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/lighten.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/hardlight.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/difference.webp' | relative_url }})
...
![]({{ '/assets/jimp/composite/exclusion.webp' | relative_url }})

我们把这几张图片放到一起，便于比较:

![]({{ '/assets/jimp/composite/overall1.webp' | relative_url }})

上面小熊图是白色背景，换一张透明背景的二维码看效果:

![]({{ '/assets/jimp/composite/overall2.webp' | relative_url }})
