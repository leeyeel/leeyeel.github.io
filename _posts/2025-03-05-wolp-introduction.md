...
有几个功能希望添加进去，但是由于现在能满足我自己的大部分需求，所以不知道还没有动力完成：

1. web增加取消关机功能

目前关机是在后台执行的，应用场景主要是让无人值守的设备关机，
但是如果有用户在工作，不希望关机的时候，可能需要取消关机。希望在web上增加功能，
点击取消即可取消本次的计划关机。

2. 增加倒计时关机提醒

与上一条类似，当客户端收到关机命令时，用户可以看到关机计划，比如还有50秒关机。

3. 客户端收到消息准备关机时增加用户提醒

当客户端收到关机消息时，弹出消息通知即将关机。

4. 增加修改端口功能

目前端口固定2025，某些情况可能会与未知的软件冲突，最好支持用户自定义端口。
