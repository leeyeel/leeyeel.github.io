---
layout: post
title:  "OpenAI Codex CLI 为什么选择 Rust：CLI Agent 的语言取舍"
...
tags:
  ...
  - "CLI-Agent"
  - "工程选型"
description: "分析 OpenAI Codex CLI 为什么最终选择 Rust 重写，并讨论 CLI Agent 的语言选型取舍。"
keywords: "Codex CLI Rust, CLI Agent 语言选型, OpenAI Codex, Rust vs Go"
excerpt: "分析 OpenAI Codex CLI 为什么最终选择 Rust 重写，并讨论 CLI Agent 的语言选型。"
mathjax: true
---
* TOC
{:toc}
